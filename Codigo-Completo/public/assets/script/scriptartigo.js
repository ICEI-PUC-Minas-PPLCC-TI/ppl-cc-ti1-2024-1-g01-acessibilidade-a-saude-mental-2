    ...
    fetch('/articles')
        ...
        .then(data => {
            ...
            data.forEach(article => {
                ...
                articleElement.innerHTML = `<h2 class="ps-3">${article.title}</h2><p class="ps-4 pe-3 text-start">${article.content}</p>`;
...
function salvarArtigo(event) {
    ...
    .then(data => {
        ...
        window.location.href = 'artigo.html'; // Redirecionar para a página artigo.html após salvar o artigo
    })
