document.addEventListener("DOMContentLoaded", function() {
    ...
    function displayPsychologists(psicologos) {
        ...
        psicologos.forEach(psicologo => {
            ...
            div.innerHTML = `
                <div class="profile">
                    <img src="assets/imagens/${psicologo.foto}" alt="Foto do Psicólogo class="foto" ">
                    <div>
                        <div class="d-flex flex-row">
                            <h3 class="p-2" style="margin-bottom: 10px">${psicologo.nome}</h3>
                            <a href="avaliacoes.html"> <div class="p-2 rating">${getRatingStars(psicologo.avaliacao,40.0)}</div> </a>
                        </div>
                        <div class="d-flex flex-row">
                            <div class="p-2">
                            ...
                            <button type="button" class="btn btn-primary" style="background-color: white; border-color: white">
                                <img style="border-radius: 0%;max-width: 80px;" src="assets/imagens/chat-icon.png" alt="Chat">
                            </button>
                        </div>
                    </div>
                </div>
    ...
    function getRatingStars(rating,tamanho) {
        ...
        return (
            `<img style="border-radius: 0%;max-width: ${tamanho}px; margin-right:${tamanho/4}px" src="assets/imagens/star-icon.png" alt="Estrela cheia">`.repeat(fullStars) +
            `<img style="border-radius: 0%;max-width: ${tamanho}px; margin-right:${tamanho/4}px" src="assets/imagens/star-half-icon.png" alt="Meia estrela">`.repeat(halfStars) +
            `<img style="border-radius: 0%;max-width: ${tamanho}px; margin-right:${tamanho/4}px" src="assets/imagens/star-empty-icon.png" alt="Estrela vazia">`.repeat(emptyStars)
        );
    }
