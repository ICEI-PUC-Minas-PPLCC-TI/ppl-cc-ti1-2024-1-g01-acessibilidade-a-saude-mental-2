function loadUserProfile(cpf) {
    fetch('/paciente')
        ...
        .then(data => {
            ...
            if (user) {
                document.getElementById('user-photo').src = "assets/images/" + user.foto;
                ...
                for (let i = 1; i <= 5; i++) {
                    ...
                    if (rating >= i) {
                        starImg.src = 'assets/images/star-icon.png';
                    } else if (rating >= i - 0.5) {
                        starImg.src = 'assets/images/star-half-icon.png';
                    } else {
                        starImg.src = 'assets/images/star-empty-icon.png';
                    }
                    starImg.alt = 'Star';
