document.addEventListener("DOMContentLoaded", function() {
    ...
    function getRatingStars(rating,tamanho) {
        ...
        return (
            `<img style="border-radius: 0%;max-width: ${tamanho}px; margin-right:${tamanho/4}px" src="images/star-icon.png" alt="Estrela cheia">`.repeat(fullStars) +
            `<img style="border-radius: 0%;max-width: ${tamanho}px; margin-right:${tamanho/4}px" src="images/star-half-icon.png" alt="Meia estrela">`.repeat(halfStars) +
            `<img style="border-radius: 0%;max-width: ${tamanho}px; margin-right:${tamanho/4}px" src="images/star-empty-icon.png" alt="Estrela vazia">`.repeat(emptyStars)
        );
    }
